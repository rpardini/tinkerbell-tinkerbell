...
// GetEC2InstanceByMetadataToken exists to satisfy the ec2.Client interface. It is not implemented.
func (n Backend) GetEC2InstanceByMetadataToken(context.Context, string) (data.Ec2Instance, error) {
	return data.Ec2Instance{}, errAlways
}
